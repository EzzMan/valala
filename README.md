...
```
bash <(curl -Ls https://raw.githubusercontent.com/EzzMan/valala/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/EzzMan/valala/master/install.sh) v1.7.1
```
