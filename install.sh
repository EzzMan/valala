...
install_x-ui() {
    ...
    if [ $# == 0 ]; then
        ...
        wget -N --no-check-certificate -O /usr/local/x-ui-linux-amd64.tar.gz https://github.com/EzzMan/valala/releases/download/v0.3.1/x-ui-linux-amd64.tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/EzzMan/valala/releases/download/v0.3.1/x-ui-linux-amd64.tar.gz"
